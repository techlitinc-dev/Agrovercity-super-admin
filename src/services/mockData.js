...
// ─── Module 09: Equipment Rental & Yantra Time-Slots (SOP-09) ───────────────
...
export const INITIAL_EQUIPMENT = [
  {
    ...
    type: "tractor",
    description: "60 HP tractor with rotavator and cultivator attachments.",
    hourlyRate: 750,
    perAcreRate: 1200,
    photoUrl: "https://images.unsplash.com/photo-1592982537447-7440770cbfc9?w=400&q=80",
    rcDocument: { number: "MH09EQ5521", verified: true },
    insuranceDocument: { policyNumber: "ICICI-AG-441022", validTill: "2027-02-18", verified: true },
    operatorLicense: { number: "MH-DL-TR-88213", validTill: "2027-04-11", verified: true },
  ...
  },
  {
    ...
    ownerMobile: "+91 97300 55210",
    ownerType: "private",
    village: "Miraj",
    district: "Sangli",
    name: "Class Crop Tiger Harvester",
    type: "harvester",
    description: "Multicrop combine harvester with operator included.",
    hourlyRate: 2600,
    perAcreRate: 2200,
    photoUrl: "https://images.unsplash.com/photo-1625246333195-78d9c38ad449?w=400&q=80",
    rcDocument: { number: "MH10EQ7789", verified: true },
    insuranceDocument: { policyNumber: "BAJAJ-AG-554310", validTill: "2026-11-30", verified: true },
    operatorLicense: { number: "MH-DL-TR-90451", validTill: "2026-10-05", verified: false },
    utilizationPercent: 81,
    pricingIndexPercent: 118,
    totalBookings: 96,
    rating: 4.2,
    status: "pending_verification",
  ...
  },
  {
    ...
    ownerMobile: "+91 91450 62330",
    ownerType: "private",
    village: "Pandharpur",
    district: "Solapur",
    name: "Shaktiman Rotavator Set",
    type: "rotavator",
    description: "6-foot rotavator with 45 HP tractor power unit.",
    hourlyRate: 650,
    perAcreRate: null,
    photoUrl: "https://images.unsplash.com/photo-1500651230702-0e2d8a49d4ad?w=400&q=80",
    rcDocument: { number: "MH11EQ3345", verified: true },
    insuranceDocument: { policyNumber: "NEWIND-AG-712099", validTill: "2026-12-20", verified: true },
    operatorLicense: { number: "MH-DL-TR-77320", validTill: "2027-08-22", verified: true },
    utilizationPercent: 44,
    pricingIndexPercent: 96,
    totalBookings: 58,
    rating: 3.9,
    status: "verified",
  ...
  },
  {
    id: "EQ-904",
    ownerId: "USR-2204",
    ownerName: "Vitthal Kamble",
    ownerMobile: "+91 99750 40112",
    ownerType: "fpo",
    fpoName: "Godavari Sahakari FPO",
    village: "Dindori",
    district: "Nashik",
    name: "Laser Land Leveler (Spectrum)",
    type: "laserLeveler",
    description: "GPS-guided laser leveler with 5 HP control unit.",
    hourlyRate: 900,
    perAcreRate: 1500,
    photoUrl: "https://images.unsplash.com/photo-1592989406573-47056e2a30f9?w=400&q=80",
    rcDocument: { number: "MH12EQ9910", verified: false },
    insuranceDocument: { policyNumber: "HDFC-AG-109877", validTill: "2027-06-11", verified: true },
    operatorLicense: { number: "MH-DL-TR-61098", validTill: "2027-01-30", verified: true },
    utilizationPercent: 52,
    pricingIndexPercent: 104,
    totalBookings: 41,
    rating: 4.4,
    status: "pending_verification",
  ...
  },
  {
    ...
    ownerMobile: "+91 98600 71234",
    ownerType: "private",
    village: "Karad",
    district: "Satara",
    name: "Swaraj 744 FE Tractor",
    type: "tractor",
    description: "48 HP tractor, trolley and MB plough attachments.",
    hourlyRate: 700,
    perAcreRate: 1100,
    photoUrl: "https://images.unsplash.com/photo-1592982537447-7440770cbfc9?w=400&q=80",
    rcDocument: { number: "MH21EQ4412", verified: true },
    insuranceDocument: { policyNumber: "TATA-AG-223190", validTill: "2026-09-25", verified: true },
    operatorLicense: { number: "MH-DL-TR-55881", validTill: "2026-12-01", verified: true },
    utilizationPercent: 73,
    pricingIndexPercent: 102,
    totalBookings: 167,
    rating: 4.5,
    status: "verified",
  ...
  },
  {
    id: "EQ-906",
    ownerId: "USR-2206",
    ownerName: "Bhausaheb Jadhav",
    ownerMobile: "+91 91234 88112",
    ownerType: "private",
    village: "Latur",
    district: "Latur",
    name: "John Deere W70 Harvester",
    type: "harvester",
    description: "Straw walker combine for wheat and soybean.",
    hourlyRate: 2800,
    perAcreRate: 2400,
    photoUrl: "https://images.unsplash.com/photo-1625246333195-78d9c38ad449?w=400&q=80",
    rcDocument: { number: "MH25EQ8823", verified: true },
    insuranceDocument: { policyNumber: "ICICI-AG-662104", validTill: "2027-03-09", verified: true },
    operatorLicense: { number: "MH-DL-TR-44129", validTill: "2027-05-16", verified: true },
    utilizationPercent: 37,
    pricingIndexPercent: 135,
    totalBookings: 22,
    rating: 3.7,
    status: "suspended",
...
export const INITIAL_EQUIPMENT_SLOTS = [
  {
    id: "EQ-901_2026-09-21_06-10",
    equipmentId: "EQ-901",
    equipmentName: "John Deere 5310 Tractor",
    ownerName: "Ram Patil",
    ownerType: "fpo",
    date: "2026-09-21",
    slotName: "06:00-10:00",
    startMin: 360,
    endMin: 600,
    duration: 240,
    priceRupees: 3000,
    recommendedTask: "Tillage",
    status: "booked",
    bookedBy: "USR-1101",
    bookedByName: "Anna Deshmukh",
    waitlist: [
      { userId: "USR-1107", name: "Kailas More", at: "2026-09-19T14:22:00.000Z" },
      { userId: "USR-1108", name: "Dnyanesh Kumbhar", at: "2026-09-19T16:05:00.000Z" }
    ],
    anomaly: null,
    createdAt: "2026-09-19T00:30:00.000Z"
  },
  {
    id: "EQ-901_2026-09-21_10-02",
    equipmentId: "EQ-901",
    equipmentName: "John Deere 5310 Tractor",
    ownerName: "Ram Patil",
    ownerType: "fpo",
    date: "2026-09-21",
    slotName: "10:00-14:00",
    startMin: 600,
    endMin: 840,
    duration: 240,
    priceRupees: 3000,
    recommendedTask: "Sowing",
    status: "available",
    bookedBy: null,
    bookedByName: null,
    waitlist: [],
  ...
  {
    id: "EQ-902_2026-09-21_10-02",
    equipmentId: "EQ-902",
    equipmentName: "Class Crop Tiger Harvester",
    ownerName: "Suresh Jadhav",
    ownerType: "private",
    date: "2026-09-21",
    slotName: "10:00-14:00",
    ...
    status: "booked",
    bookedBy: "USR-1102",
    bookedByName: "Sunita Patil",
    waitlist: [{ userId: "USR-1109", name: "Ravi Chavan", at: "2026-09-20T08:11:00.000Z" }],
    anomaly: "double_booked",
    createdAt: "2026-09-19T00:30:00.000Z"
  },
  {
    id: "EQ-903_2026-09-22_06-10",
    equipmentId: "EQ-903",
    equipmentName: "Shaktiman Rotavator Set",
    ownerName: "Mahadev Shinde",
    ownerType: "private",
    date: "2026-09-22",
    slotName: "06:00-10:00",
    ...
    status: "pending",
    bookedBy: "USR-1103",
    bookedByName: "Vandana Shinde",
    waitlist: [],
    anomaly: null,
    createdAt: "2026-09-19T00:30:00.000Z"
  },
  {
    id: "EQ-905_2026-09-21_14-06",
    equipmentId: "EQ-905",
    equipmentName: "Swaraj 744 FE Tractor",
    ownerName: "Ganesh Pawar",
    ownerType: "private",
    date: "2026-09-21",
    slotName: "14:00-18:00",
    startMin: 840,
    endMin: 1080,
    duration: 240,
    priceRupees: 2800,
    recommendedTask: "Spraying",
    status: "booked",
    bookedBy: "USR-1104",
    bookedByName: "Prakash Solanke",
    waitlist: [],
    anomaly: null,
    createdAt: "2026-09-19T00:30:00.000Z"
  },
  {
    id: "EQ-905_2026-09-21_06-10",
    equipmentId: "EQ-905",
    equipmentName: "Swaraj 744 FE Tractor",
    ownerName: "Ganesh Pawar",
    ownerType: "private",
  ...
  {
    id: "EQ-904_2026-09-23_06-10",
    equipmentId: "EQ-904",
    equipmentName: "Laser Land Leveler (Spectrum)",
    ownerName: "Vitthal Kamble",
    ownerType: "fpo",
    date: "2026-09-23",
    slotName: "06:00-10:00",
...
export const INITIAL_EQUIPMENT_BOOKINGS = [
  {
    id: "EQB-901",
    slotId: "EQ-901_2026-09-21_06-10",
    equipmentId: "EQ-901",
    equipmentName: "John Deere 5310 Tractor",
    farmerId: "USR-1101",
    farmerName: "Anna Deshmukh",
    farmerMobile: "+91 98221 33401",
    date: "2026-09-21",
    slotName: "06:00-10:00",
  ...
  {
    id: "EQB-902",
    slotId: "EQ-902_2026-09-21_10-02",
    equipmentId: "EQ-902",
    equipmentName: "Class Crop Tiger Harvester",
    farmerId: "USR-1102",
    farmerName: "Sunita Patil",
    farmerMobile: "+91 98221 77120",
    date: "2026-09-21",
    slotName: "10:00-14:00",
  ...
  {
    id: "EQB-904",
    slotId: "EQ-903_2026-09-22_06-10",
    equipmentId: "EQ-903",
    equipmentName: "Shaktiman Rotavator Set",
    farmerId: "USR-1103",
    farmerName: "Vandana Shinde",
    farmerMobile: "+91 98220 61278",
    date: "2026-09-22",
    slotName: "06:00-10:00",
  ...
  {
    id: "EQB-905",
    slotId: "EQ-905_2026-09-21_14-06",
    equipmentId: "EQ-905",
    equipmentName: "Swaraj 744 FE Tractor",
    farmerId: "USR-1104",
    farmerName: "Prakash Solanke",
    farmerMobile: "+91 98223 45219",
    date: "2026-09-21",
    slotName: "14:00-18:00",
    ...
    damageReport: {
      reported: true,
      description: "Farmer reports hydraulic leak and broken trolley hitch after completed slot on 2026-09-18; owner claims repair estimate of ₹62,000.",
      reportedAt: "2026-09-18T17:30:00.000Z",
      depositAction: "pending"
    },
    signOffs: [],
  ...
  {
    id: "EQB-906",
    slotId: "EQ-902_2026-09-22_06-10",
    equipmentId: "EQ-902",
    equipmentName: "Class Crop Tiger Harvester",
    farmerId: "USR-1105",
    farmerName: "Shobha Gaikwad",
    farmerMobile: "+91 98224 11209",
    date: "2026-09-22",
    slotName: "06:00-10:00",
    startAt: "2026-09-22T06:00:00.000Z",
    priceRupees: 10400,
    ...
    damageReport: {
      reported: true,
      description: "Operator negligence caused crop-row damage across 2.5 acres; owner seeks full deposit forfeiture of ₹60,000.",
  ...
  {
    id: "EQB-907",
    slotId: "EQ-901_2026-09-18_06-10",
    equipmentId: "EQ-901",
    equipmentName: "John Deere 5310 Tractor",
    farmerId: "USR-1106",
    farmerName: "Kailas More",
    farmerMobile: "+91 98225 67001",
    date: "2026-09-18",
    slotName: "06:00-10:00",
  ...
  {
    id: "EQB-908",
    slotId: "EQ-903_2026-09-17_14-06",
    equipmentId: "EQ-903",
    equipmentName: "Shaktiman Rotavator Set",
    farmerId: "USR-1107",
    farmerName: "Dnyanesh Kumbhar",
    farmerMobile: "+91 98226 88213",
    date: "2026-09-17",
    slotName: "14:00-18:00",
    ...
    ownerType: "private",
    status: "cancelled",
    cancelReason: "Admin force cancellation: machine breakdown reported mid-slot; full refund of ₹2,600 issued to farmer.",
    refundAmount: 2600,
    damageReport: null,
    signOffs: [],
