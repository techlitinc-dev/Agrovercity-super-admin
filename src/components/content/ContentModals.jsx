...
export function ResetSeedModal({
  ...
  const [reason, setReason] = useState('Restoring SOP-20 benchmark dataset for testing and verification.')
  const [error, setError] = useState('')
    ...
    <div className="fixed inset-0 z-50 overflow-y-auto bg-slate-900/40 backdrop-blur-xs flex items-center justify-center p-4">
      <div className="bg-white border border-rose-200 rounded-2xl max-w-md w-full p-6 shadow-2xl space-y-4 animate-in fade-in zoom-in-95 duration-200">
        <div className="flex items-center gap-3 text-rose-600">
          ...
          <div>
            <h3 className="text-base font-bold text-slate-900">Reset Knowledge Hub Benchmark Data</h3>
            <span className="text-[11px] font-mono text-rose-600 font-bold">SOP-20 Target Collections Reset</span>
          </div>
        </div>

        <p className="text-xs text-slate-600 leading-relaxed">
          This will restore all 6 Knowledge Hub collections (<code className="bg-slate-100 px-1 py-0.5 rounded font-mono">agri_news</code>, <code className="bg-slate-100 px-1 py-0.5 rounded font-mono">agri_channels</code>, <code className="bg-slate-100 px-1 py-0.5 rounded font-mono">workshops</code>, <code className="bg-slate-100 px-1 py-0.5 rounded font-mono">expert_talks</code>, <code className="bg-slate-100 px-1 py-0.5 rounded font-mono">video_guides</code>, <code className="bg-slate-100 px-1 py-0.5 rounded font-mono">blog_articles</code>) and workshop rosters back to the official SOP-20 benchmark dataset.
        </p>
...
// -------------------------------------------------------------
// 13. BATCH ACTION CONFIRMATION MODAL
// -------------------------------------------------------------
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-slate-900/40 backdrop-blur-xs flex items-center justify-center p-4">
      <div className="bg-white border border-emerald-100/90 rounded-2xl max-w-md w-full p-6 shadow-2xl space-y-4 animate-in fade-in zoom-in-95 duration-200">
        ...
        <p className="text-xs text-slate-600 leading-relaxed">
          You are about to execute a bulk update on <strong className="text-slate-900">{count}</strong> records simultaneously. This batch action will be logged in the immutable audit trail.
        </p>
